for cls in lr; do
    for seed in 1 2 3; do
        ...
        CUDA_VISIBLE_DEVICES=1 python a2c_ucb.py --env-name BattleZoneNoFrameskip-v4 --seed $seed \
            --cls ${cls} --expl_coef 1.0 --window_length 10 \
            --log-dir logs/a2c_ucb_${cls}_BattleZone_s$seed >logs/a2c_ucb_${cls}_cuda1_s$seed.log 2>&1 &
        ...
        #     --cls ${cls} --expl_coef 5.0 --window_length 50 \
