...
best_ucb = {'bigfish': 'drac_ucb_c=5.0_w=50', 'bossfight': 'drac_ucb_c=5.0_w=100', 'caveflyer': 'drac_ucb_c=5.0_w=50', 
            ...
            'fruitbot': 'drac_ucb_c=1.0_w=10', 'heist': 'drac_ucb', 'jumper': 'drac_ucb_c=5.0_w=100', 'leaper': 'drac_ucb_c=5.0_w=100', 
            'maze': 'drac_ucb', 'miner': 'drac_ucb', 'ninja': 'drac_ucb_c=5.0_w=100', 'plunder': 'drac_ucb', 'starpilot': 'drac_ucb'}
best_ts = {'bigfish': 'drac_ts_w=50_eta=1.0', 'bossfight': 'drac_ts', 'caveflyer': 'drac_ts_w=50_eta=1.0', 'chaser': 'drac_ts_w=50_eta=0.5',
            ...
            'miner': 'drac_ts_w=50_eta=0.1', 'ninja': 'drac_ts_w=100_eta=1.0', 'plunder': 'drac_ts_w=100_eta=1.0', 'starpilot': 'drac_ts'}
